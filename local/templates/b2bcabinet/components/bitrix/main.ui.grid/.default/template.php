...
Asset::getInstance()->addJs($templateFolder . "/js/action-panel.js");
Asset::getInstance()->addJs($templateFolder . "/js/baseclass.js");
Asset::getInstance()->addJs($templateFolder . "/js/cols-sortable.js");
Asset::getInstance()->addJs($templateFolder . "/js/data.js");
Asset::getInstance()->addJs($templateFolder . "/js/dropdown.js");
Asset::getInstance()->addJs($templateFolder . "/js/dropdown-manager.js");
Asset::getInstance()->addJs($templateFolder . "/js/element.js");
Asset::getInstance()->addJs($templateFolder . "/js/fader.js");
Asset::getInstance()->addJs($templateFolder . "/js/gridupdater.js");
Asset::getInstance()->addJs($templateFolder . "/js/inline-editor.js");
Asset::getInstance()->addJs($templateFolder . "/js/loader.js");
Asset::getInstance()->addJs($templateFolder . "/js/manager.js");
Asset::getInstance()->addJs($templateFolder . "/js/message.js");
Asset::getInstance()->addJs($templateFolder . "/js/observer.js");
Asset::getInstance()->addJs($templateFolder . "/js/oldgrid.js");
Asset::getInstance()->addJs($templateFolder . "/js/pagesize.js");
Asset::getInstance()->addJs($templateFolder . "/js/pagination.js");
Asset::getInstance()->addJs($templateFolder . "/js/pin-header.js");
Asset::getInstance()->addJs($templateFolder . "/js/pin-panel.js");
Asset::getInstance()->addJs($templateFolder . "/js/resize.js");
Asset::getInstance()->addJs($templateFolder . "/js/row.js");
Asset::getInstance()->addJs($templateFolder . "/js/rows.js");
Asset::getInstance()->addJs($templateFolder . "/js/rows-sortable.js");
Asset::getInstance()->addJs($templateFolder . "/js/settings.js");
Asset::getInstance()->addJs($templateFolder . "/js/settings-window.js");
Asset::getInstance()->addJs($templateFolder . "/js/settings-window-column.js");
Asset::getInstance()->addJs($templateFolder . "/js/submenu.js");
Asset::getInstance()->addJs($templateFolder . "/js/useroptions.js");
Asset::getInstance()->addJs($templateFolder . "/js/utils.js");
		...
		?><div class="main-grid-settings-window"><?
			...
			?><div class="popup-window-buttons"><?
				?><span class="main-grid-settings-window-buttons-wrapper"><?
					?><span class="main-grid-settings-window-actions-item-button main-grid-settings-window-actions-item-reset" id="<?=$arParams["GRID_ID"]?>-grid-settings-reset-button"><i class="icon-undo mr-2"></i><?=Loc::getMessage("interface_grid_restore_to_default")?></span><?
					if ($USER->CanDoOperation("edit_other_settings")) :
					?><div class="main-grid-settings-window-actions-item-button main-grid-settings-window-for-all" style="display: inline-flex;">
						<input name="grid-settings-window-for-all" type="checkbox" id="<?=$arParams["GRID_ID"]?>-main-grid-settings-window-for-all-checkbox" class="form-input-styled">
                ...
                ?>
                <span>
                <span class="btn btn_save" id="<?=$arParams["GRID_ID"]?>-grid-settings-apply-button"><?=Loc::getMessage("interface_grid_apply_settings")?></span>
                     <span class="btn btn-link" id="<?=$arParams["GRID_ID"]?>-grid-settings-cancel-button"><?=Loc::getMessage("interface_grid_cancel_settings")?></span>
                </span><?
			?></div><?
		?></div><?
								...
								?><tr class="main-grid-row main-grid-row-empty main-grid-row-body"><?
									?><td class="main-grid-cell main-grid-cell-center" colspan="<?=count($arParams['COLUMNS']) + $additionalColumnsCount ?>"><?
										if (!isset($_REQUEST["apply_filter"])) :
											?><div class="main-grid-empty-block_"><?
										...
										if ($arParams["SHOW_ROW_ACTIONS_MENU"] || $arParams["SHOW_GRID_SETTINGS_MENU"]) :
											...
											?><td class="<?=$className?>"<?=$isShift ? " style=\"padding-left: ".($depth)."px\" data-shift=\"true\"" : ""?>><?
												?><span class="main-grid-cell-content" data-prevent-default="<?=$preventDefault?>"><?
													...
													{
														if($id=="ID"){
															?><a href="#" onclick="<?=Text\HtmlFilter::encode($sDefAction["js"])?>; return false;"><?echo $arRow["columns"][$header["id"]];?></a><?
														}
														else{
					...
					?><tr><?
						if ($arParams["SHOW_SELECTED_COUNTER"]) : ?><?
							?><td class="main-grid-panel-cell main-grid-panel-counter main-grid-cell-left"><?
								?><div class="main-grid-panel-content main-grid-panel-counter-for-selected pagination_index_support"><?

...
Asset::getInstance()->addJs($templateFolder . "/js/search.js");
Asset::getInstance()->addJs($templateFolder . "/js/utils.js");
Asset::getInstance()->addJs($templateFolder . "/js/api.js");
Asset::getInstance()->addJs($templateFolder . "/js/destination-selector.js");
Asset::getInstance()->addJs($templateFolder . "/js/field-controller.js");
Asset::getInstance()->addJs($templateFolder . "/js/main-ui-control-custom-entity.js");
Asset::getInstance()->addJs($templateFolder . "/js/presets.js");
Asset::getInstance()->addJs($templateFolder . "/js/fields.js");

Asset::getInstance()->addJs($templateFolder . "/blocks/date-group.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-control-field.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-control-field-group.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-control-string.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-filter-field-list-item.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-filter-info.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-number.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/main-ui-search-square.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/number-group.js");
Asset::getInstance()->addJs($templateFolder . "/blocks/sidebar-item.js");
				...
				<div class="main-ui-filter-bottom-controls">
					...
					<div class="main-ui-filter-field-preset-button-container">
						<div class="main-ui-filter-field-button-inner">
							<button class="main-ui-filter-find btn btn_b2b">
								<?= Loc::getMessage("MAIN_UI_FILTER__FIND") ?></button>
							<span class="main-ui-filter-reset btn btn-light">
					...
					<div class="main-ui-filter-field-button-container">
						<div class="main-ui-filter-field-button-inner">
							...
							<? endif; ?>
							<span class="main-ui-filter-save btn btn_b2b">
							<?= Loc::getMessage("MAIN_UI_FILTER__BUTTON_SAVE") ?></span>
							<span class="main-ui-filter-cancel btn btn-light">

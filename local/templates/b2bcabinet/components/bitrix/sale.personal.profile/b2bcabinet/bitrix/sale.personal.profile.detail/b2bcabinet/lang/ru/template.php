...
$MESS ['SPPD_EDIT_PROFILE'] = 'Редактирование профиля № #ID#';
$MESS ['SPPD_COMMON'] = 'Общие';

$MESS ['OPP_DOWNLOAD_DOC'] = 'Скачать';
$MESS ['OPP_DELETE_DOC'] = 'Удалить';
$MESS ['OPP_DELETE_CONFIRM_MESS'] = 'Вы уверены, что хотите удалить документ?';

					...
					<div class="card-body">
						<div class="blank_detail-menu">
							<ul class="nav nav-tabs nav-tabs-highlight">
								...
								<li class="nav-item">
									<a href="#basic-tab3" class="nav-link" data-toggle="tab"><?= Loc::getMessage('SPOD_TAB_DOCS') ?></a>
								</li>
								<li class="nav-item">
									<a href="#basic-tab4" class="nav-link" data-toggle="tab"><?= Loc::getMessage('SPOD_TAB_PAYS') ?></a>
								</li>
								<li class="nav-item">
									<a href="#basic-tab5" class="nav-link" data-toggle="tab"><?= Loc::getMessage('SPOD_TAB_SHIPMENTS') ?></a>
								</li>
								<li class="nav-item">
								...
								<div class="row">
									<div class="flex-column">
										<div class="col-md-12 my-2">
											<div class="card">
												<div class="card-header header-elements-inline blank_detail-card_headers">
													<h6 class="card-title"><?= Loc::getMessage('SPOD_SUB_ORDER_TITLE', [
										...
										<table class="table table-bordered">
											...
											<tr>
												<th rowspan="2" class="text-center">
													<h4><?= Loc::getMessage("SPOD_ORDER_BASKET") ?></h4></th>

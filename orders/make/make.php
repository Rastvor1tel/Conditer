...
<?$APPLICATION->IncludeComponent("bitrix:sale.order.ajax",
    ...
    Array(
        ...
        "PATH_TO_BASKET" => SITE_DIR."orders/make/index.php",	// Путь к странице корзины
        "PATH_TO_ORDER" => SITE_DIR."orders/make/make.php",      // Путь к странице оформления заказа
        "PATH_TO_PAYMENT" => SITE_DIR."orders/payment/index.php",	// Страница подключения платежной системы
        "PATH_TO_PERSONAL" => SITE_DIR."orders/index.php",	// Путь к странице персонального раздела
